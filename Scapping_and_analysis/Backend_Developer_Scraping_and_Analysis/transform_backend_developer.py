...
def mult_requirements():
    dff = pd.read_pickle(r'backend_developer.pickle')
    print("*********************************************************************")
    print(len(dff))
    print("*********************************************************************")

    # 5200
    df = list(dff.values())[4001:]
    count = 0
    first_dict = {}
    second_dict = {}
    third_dict = {}
    ...
    with open("first_dict_be5.pickle", "wb") as h1:
        pickle.dump(first_dict, h1)
    with open("second_dict_be1.pickle", "wb") as h2:
        pickle.dump(second_dict, h2)
    with open("third_dict_be2.pickle", "wb") as h3:
        pickle.dump(third_dict, h3)
    with open("fourth_dict_be3.pickle", "wb") as h4:
        pickle.dump(fourth_dict, h4)
    with open("fifth_dict_be4.pickle", "wb") as h5:
        pickle.dump(fifth_dict, h5)

    df1 = pd.read_pickle(r'first_dict_be5.pickle')
    print(len(df1))
    df2 = pd.read_pickle(r'second_dict_be1.pickle')
    print(len(df2))
    df3 = pd.read_pickle(r'third_dict_be2.pickle')
    print(len(df3))
    df4 = pd.read_pickle(r'fourth_dict_be3.pickle')
    print(len(df4))
    df5 = pd.read_pickle(r'fifth_dict_be4.pickle')
    print(len(df5))
